    ...
    <div class="app-sidebar colored">
        <div class="sidebar-header">
            <a class="header-brand" href="index.html">
                ...
                <span class="text">Medical Clinic</span>
            </a>
        ...
        <div class="sidebar-content">
            <div class="nav-container">
                <nav id="main-menu-navigation" class="navigation-main">
                    ...
                    <!-- links available on the letf sidebar only for user admin-->
                ...
                @endif
                    ...
                    <!-- links available on the letf sidebar only for users doctors-->
                    ...
                    @if (auth()->check() && auth()->user()->role->name === 'admin')
                        <div class="nav-item has-sub">
                            ...
                            <div class="submenu-content">
                                ...
                                <a href="{{ route('all.appointments') }}" class="menu-item">All time Appontments</a>
                            </div>
                        </div>
                    @endif
