                ...
                <div class="card-body">
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <td><input type="checkbox" name="time[]" value="6.20am" @if(isset($times)){{ $times->contains('time','6am')?'checked':'' }}@endif> 6.20am</td>
    ...
    <h3>Your appointment time list</h3>
            ...
            <table class="table table-stripped">
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row"></th>
                        <td>{{ $appointment->doctor->name}}</td> <!-- ou {{auth()->user()->name}} -->
