                            ...
                            <tbody>
                                @forelse ($bookings as $key=>$booking)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="/profiles/{{$booking->user->image}}" width="80" style="border-radius: 50%;">
                                        </td>
                                        <td>{{ $booking->date }}</td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal{{ $booking->user_id }}">Write prescription</button>
                                ...
                                @empty
                                <td>There is no appointments for this day!</td>
                                @endforelse
