...
<head>
    ...
    <title>{{ config('app.name', "Family Joy Clinic") }}</title>
...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', "Family Joy Clinic") }}
                </a>
    ...
    <script>
        var dateToday = new Date();        //para mostrar apenas os dias após o dia atual, e 2 meses
        $( function() {
